...
# ============================================================
CUDA=2
METHOD=prumerge        # original | prumerge | prumerge_plus
...
ANSWERS_FILE=./playground/data/eval/textvqa/answers/${EXP_NAME}.jsonl
...
CONFIG_FILE="./playground/data/eval/textvqa/answers/${EXP_NAME}_config.json"
cat > "$CONFIG_FILE" << EOF
{
  "exp_name": "$EXP_NAME",
  "method": "$METHOD",
...
$PYTHON -m llava.eval.eval_textvqa \
    ...
    | tee "./playground/data/eval/textvqa/answers/${EXP_NAME}_results.txt"
