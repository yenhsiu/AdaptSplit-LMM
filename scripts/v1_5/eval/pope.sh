...
ANSWERS_FILE=./playground/data/eval/pope/answers/${EXP_NAME}.jsonl
...
CONFIG_FILE="./playground/data/eval/pope/answers/${EXP_NAME}_config.json"
cat > "$CONFIG_FILE" << EOF
{
  "exp_name": "$EXP_NAME",
  "method": "$METHOD",
...
$PYTHON llava/eval/eval_pope.py \
    --annotation-dir /mnt/ssd/yenhsiu_datasets/POPE/pope_annotations \
    --question-file ./playground/data/eval/pope/llava_pope_test.jsonl \
    --result-file "$ANSWERS_FILE" \
    | tee "./playground/data/eval/pope/answers/${EXP_NAME}_results.txt"
